...
set job_name       = p05m052l_no_sanity
set compset        = FC5AV1C
set resolution     = ne30_ne30
set machine        = cori-knl
set walltime       = 00:15:00
setenv project       m3525
set FKB_wgt        = p05_model05_TWO-LAYER.txt 

### SOURCE CODE OPTIONS
set fetch_code     = false
set e3sm_tag       = master
set tag_name       = E3SM.sungduk

### CUSTOM CASE_NAME
set case_name = ${tag_name}.${job_name}
...
set seconds_before_delete_case_dir   =  5
set seconds_before_delete_bld_dir    =  5
set seconds_before_delete_run_dir    =  5
...
### DIRECTORIES
set code_root_dir               = /project/projectdirs/m3525/sungduk/E3SM_collections/maint1.0
set e3sm_simulations_dir        = /global/cscratch1/sd/sungduk/e3sm_scratch
...
set start_date                  = '0000-01-01' #default
...
### DNN WEIGHT FILE (moved to L676)
# cp -v ${code_root_dir}/${tag_name}/components/cam/src/physics/cam/ndrop.F90 ${e3sm_simulations_dir}/${case_name}/case_scripts/SourceMods/src.cam/
# sed -i "s|FKB_WEIGHT_TXT|${FKB_wgt}|g" ${e3sm_simulations_dir}/${case_name}/case_scripts/SourceMods/src.cam/ndrop.F90
# cp -v ${code_root_dir}/${tag_name}/${FKB_wgt} ${case_run_dir}
...
### Copy ndrop.F90 and FKB weight txt files
cp -v ${code_root_dir}/${tag_name}/components/cam/src/physics/cam/ndrop.F90 ${e3sm_simulations_dir}/${case_name}/case_scripts/SourceMods/src.cam/
sed -i "s|FKB_WEIGHT_TXT|${FKB_wgt}|g" ${e3sm_simulations_dir}/${case_name}/case_scripts/SourceMods/src.cam/ndrop.F90
cp -v ${code_root_dir}/${tag_name}/${FKB_wgt} ${case_run_dir}
...
## clubb_c14              =   1.06D0
## zmconv_ke              =   5.0E-6
## ncdata         = '/project/projectdirs/m3525/inic/1980/EAMv1_1980.cam.i.1999-01-01-00000.nc'
## ext_frc_specifier              = 'SO2         -> /project/projectdirs/e3sm/inputdata/atm/cam/chem/trop_mozart_aero/emis/DECK_ne30/cmip6_mam4_so2_elev_1850-2014_c180205.nc',
...
## srf_emis_specifier             = 'DMS       -> /project/projectdirs/e3sm/inputdata/atm/cam/chem/trop_mozart_aero/emis/DMSflux.2000.1deg_latlon_conserv.POPmonthlyClimFromACES4BGC_c20160226.nc',
...
## finidat = '/project/projectdirs/m3525/inic/1980/EAMv1_1980.clm2.r.1999-01-01-00000.nc'
## /
## EOF
